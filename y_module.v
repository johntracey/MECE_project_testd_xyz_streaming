//Y-Value will take the each sample and multiply it by 10 to simulate amplification
`timescale 1 ns / 1 ps
	...
	always @(posedge m00_axis_aclk)begin //carry out the operation on each clock cycle
        if (m00_axis_aresetn==0)begin
            ...
            m00_axis_tdata_reg <=10*s00_axis_tdata; //Y-Value will multiply each sample by 10 
        end
    end
